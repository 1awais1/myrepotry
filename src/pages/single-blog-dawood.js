...
import DawoodImg from '../assets/images/platforms/deadp.jpg'
import BlogImg1 from '../assets/images/platforms/node.png'
...
<br/>
                                    <p>Hi I'm a backend developer with a Computer Science degree from UET.I've been working with backend for quite a while now .</p>
                                   ...
                                   <p>He has extensive knowledge in Graph-QL integration as well as Backend experience. He also trains the interns for the backend development.</p>
<div>
<h3>Expertise</h3>
                                    ...
                                    <ul className="features-list">
                                        <li><i className='bx bx-badge-check'></i> I play for the team the team</li>
                                        ...
                                        <li><i className='bx bx-badge-check'></i> I'm good at coming up with solutions</li>
                                    </ul>

                                    <h3>Role at AugerSoft</h3>
                                    <p>I'm the backend guy for Augersoft.</p>
                                    <p>I manage the backend-development along with my team lead</p>
                                    <p>I work with my team to yeild most efficent projects there are. </p>
